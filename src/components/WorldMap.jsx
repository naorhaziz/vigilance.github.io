...
// Based on Mercator projection percentages (x = longitude normalized, y = latitude normalized)
const countryCoordinates = {
  'United States': { x: 15, y: 38 },
  'Canada': { x: 16, y: 28 },
  'UK': { x: 49, y: 32 },
  'United Kingdom': { x: 49, y: 32 },
  'France': { x: 50.5, y: 37 },
  'Germany': { x: 52, y: 34 },
  'Israel': { x: 55.5, y: 45 },
  'Middle East': { x: 58, y: 44 },
  'China': { x: 75, y: 38 },
  'India': { x: 68, y: 48 },
  'Asia': { x: 72, y: 42 },
  'Europe': { x: 51, y: 35 },
  'Palestine': { x: 55.5, y: 45 },
  'Gaza': { x: 55.5, y: 45 },
  'West Bank': { x: 56, y: 45 },
  'Russia': { x: 65, y: 28 },
  'Ukraine': { x: 54, y: 36 },
  'Japan': { x: 82, y: 40 },
  'South Korea': { x: 78, y: 42 },
  'Australia': { x: 80, y: 65 },
  'Brazil': { x: 28, y: 56 },
  'Mexico': { x: 12, y: 48 },
  'Egypt': { x: 54, y: 47 },
  'Saudi Arabia': { x: 58, y: 50 },
  'UAE': { x: 60, y: 51 },
  'Turkey': { x: 55, y: 41 },
  'Iran': { x: 62, y: 44 },
  'Pakistan': { x: 66, y: 46 },
  'Afghanistan': { x: 64, y: 43 },
  'Iraq': { x: 58, y: 45 },
  'Syria': { x: 57, y: 43 },
  'Lebanon': { x: 56, y: 44 },
  'Jordan': { x: 56.5, y: 45 },
